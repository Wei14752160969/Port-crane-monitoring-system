...
class MyMplCanvas(FigureCanvas):
    ...
    def angle_1_plot(self):
        ...
        for i in range(0, 60):
            ...
            sheet.append([str(nowTime1)[0:8], str(randomNum1)[0:8]])
        wb1.save('倾角1.xlsx')
        ...
        for i in range(0, 60):
            ...
            sheet.append([str(nowTime3), str(randomNum3)[0:8]])
        wb3.save('倾角3.xlsx')
...
class angle_1(QWidget):
    def __init__(self, parent=None):
        super(angle_1, self).__init__(parent)
        self.initUi()

    def initUi(self):
        self.layout = QVBoxLayout(self)
        self.mpl = MyMplCanvas(self, width=5, height=4, dpi=100)
        self.mpl.angle_1_plot()
        self.layout.addWidget(self.mpl)

if __name__ == '__main__':
    app = QApplication(sys.argv)
    ui = angle_1()
    ui.mpl.angle_1_plot()  # 测试静态图效果
    ui.show()
    sys.exit(app.exec_())